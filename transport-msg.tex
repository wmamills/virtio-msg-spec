...
\begin{itemize}
  ...
  \item \field{dev_num}:
     Identifies the Device Number the message is targetting or is coming from for
...
\begin{enumerate}
  \item \textbf{Obtain Device Information:}  
    ...
    and configuration size using \msgref{GET_DEVICE_INFO}.
...
suppported, verifying the target device number exists).
