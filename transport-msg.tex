...
\begin{itemize}
  \item \busref{EVENT_DEVICE} with state ready for a newly available device,
  \item \busref{EVENT_DEVICE} with state removed for a device that is no longer accessible.
\end{itemize}
...
\hline
\hline
DEVICE_BUS_STATE_READY      & 0x0  & Device is present and ready \\
\hline
DEVICE_BUS_STATE_REMOVED    & 0x1  & Device is no longer present \\
\hline
reserved          & 0x2 to 0x7FFF & Reserved for standard use \\
\hline
