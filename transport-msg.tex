...
\begin{itemize}
  ...
  \item \textbf{Device}: Implement virtio device functionality and
        ...
        the correct device instance based on device ID.
\end{itemize}
...
inconsistent updates. This count is incremented whenever the device
...
messages} to the correct device for each device ID. Typically, the bus does
...
A driver typically sends these messages to a known device ID,
...
This message is sent by the virtio-msg device and does not require a response.
...
This message is sent by the virtio-msg driver and does not require a response.
...
This message is sent by the virtio-msg device side bus and does not require a
response.
...
This message is sent by the virtio-msg driver side bus or device side bus
