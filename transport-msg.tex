...
or the response to \msgref{GET_CONFIG} which also both provide the current
configuration count of the device. The device may change any amount of data for one
...
If the request generation count matches the device generation count when
