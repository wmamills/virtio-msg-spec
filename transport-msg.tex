...
interpret the \field{token} field directly. Some response payloads repeat
request parameters (for example, indices or offsets) to support validation;
these repeats are informational and do not alter the correlation model
described here.
