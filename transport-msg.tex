...
A bus implementation MUST transmit reserved header bits and unspecified header
values as zero, and drivers and devices MUST ignore those bits on receive to
...
bus implementation may translate these notifications into an out-of-band
mechanism or deliver them in-band.
